...
func FetchAndPrint(opts Options) {
	...
	printList(&cm, opts.ShowContainers, opts.ShowPods, opts.ShowUtil, opts.ShowPodCount, showNamespace, opts.OutputFormat, opts.SortBy, opts.AvailableFormat, opts.PrintNodeLabels)
}
